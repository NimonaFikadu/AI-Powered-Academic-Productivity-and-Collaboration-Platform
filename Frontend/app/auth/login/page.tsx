      ...
      <div className="flex w-full flex-col lg:w-[55%] relative z-10 bg-white dark:bg-slate-950 transition-colors duration-300">
        ...
        <div className="absolute top-0 left-0 right-0 flex items-center justify-between p-6 sm:p-8 md:px-12">
          ...
          <div className="flex items-center gap-4">
            <div className="text-sm font-medium">
              <span className="text-slate-500 dark:text-slate-400 hidden sm:inline">{t('auth.dontHaveAccount')} </span>
              <Link href="/auth/signup" className="text-[#0B74FF] hover:text-[#5C3CC2] dark:hover:text-[#8b61ff] transition-colors font-semibold">
        ...
        <div className="flex flex-1 items-center justify-center px-4 sm:px-8 py-24">
          <div className="w-full max-w-[400px]">
            <div className="mb-8">
              <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">{t('auth.welcomeBack')}</h1>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-5">
              <div className="relative">
                ...
                {/* Wrap FormInput and override internal styling through inheritance/specific classes */}
              ...
              <div className="relative">
                ...
                <div className="mt-2 flex justify-end">
                  <Link
                    ...
                    className="text-xs font-semibold text-[#0B74FF] hover:text-[#5C3CC2] dark:hover:text-[#8b61ff] transition-colors"
                  >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`mt-4 inline-flex w-full items-center justify-between rounded-full bg-gradient-to-r from-[#0B74FF] to-[#7B2CBF] px-6 py-3.5 text-[15px] font-semibold text-white shadow-lg shadow-blue-500/25 transition-all active:scale-[0.98] ${
        ...
        <div className="absolute bottom-0 left-0 right-0 flex items-center justify-center p-6 sm:p-8 md:px-12">
          <div className="hidden sm:flex items-center gap-2 text-[10px] uppercase tracking-wider font-bold text-slate-400 dark:text-slate-500">
            <span className="rounded-full border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 px-3 py-1.5 transition-colors">{t('auth.fastSetup')}</span>
            <span className="rounded-full border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 px-3 py-1.5 transition-colors">{t('auth.privateNotes')}</span>
            <span className="rounded-full border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 px-3 py-1.5 transition-colors">{t('auth.aiPowered')}</span>
          </div>
        </div>
      </div>
