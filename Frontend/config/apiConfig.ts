...
export const API_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    USER_DELETE: (id: string) => `${API_BASE_URL}/admin/users/${id}`,
    MATERIALS: `${API_BASE_URL}/admin/materials`,
    MATERIAL_DELETE: (id: string) => `${API_BASE_URL}/admin/materials/${id}`,
    NOTES: `${API_BASE_URL}/admin/notes`,
    NOTE_DELETE: (id: string) => `${API_BASE_URL}/admin/notes/${id}`,
